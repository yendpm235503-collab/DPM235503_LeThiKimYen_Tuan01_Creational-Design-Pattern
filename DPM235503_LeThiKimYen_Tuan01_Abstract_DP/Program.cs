...
namespace DPM235503_LeThiKimYen_Tuan01_Abstract_DP
{
    ...
    public class ConcreteProductA1 : IAbstractProductA { public string UsefulFunctionA() => "Kết quả từ Product A1"; }
    public class ConcreteProductA2 : IAbstractProductA { public string UsefulFunctionA() => "Kết quả từ Product A2"; }

    public interface IAbstractProductB { string UsefulFunctionB(); }
    public class ConcreteProductB1 : IAbstractProductB { public string UsefulFunctionB() => "Kết quả từ Product B1"; }
    public class ConcreteProductB2 : IAbstractProductB { public string UsefulFunctionB() => "Kết quả từ Product B2"; }
